<%-- 
    Document   : index.jsp
    Created on : Feb 13, 2024, 1:33:07 AM
    Author     : dell
--%>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    <h1>
                      Identifiant Digital <br>
                      <span>
                        Civil et Social
                      </span>
                    </h1>
                    <p>
                      Premier pas pour un accès simple, sûr et inclusif aux programmes d'appui social étatiques.

Inscription gratuite et ouverte à tous les citoyens marocains et les étrangers résidants au Maroc de tout âge.
                    </p>
                    <div class="btn-box">
                      <a href="form5.jsp" class="btn-1"> Demander </a>
                      <a href="checkstatus.jsp" class="btn-2">Suivre</a>
                    </div>
                  </div>
                </div>
              </div>
